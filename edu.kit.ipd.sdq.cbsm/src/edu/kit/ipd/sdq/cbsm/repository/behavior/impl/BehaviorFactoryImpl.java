...
public class BehaviorFactoryImpl extends EFactoryImpl implements BehaviorFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BehaviorPackage.COMPONENT_BEHAVIOR_DESCRIPTION: return createComponentBehaviorDescription();
			...
			case BehaviorPackage.BRANCH: return createBranch();
			case BehaviorPackage.BRANCH_PATH: return createBranchPath();
			default:
	 ...
	 * @generated
	 */
	public ComponentBehaviorDescription createComponentBehaviorDescription() {
		ComponentBehaviorDescriptionImpl componentBehaviorDescription = new ComponentBehaviorDescriptionImpl();
		return componentBehaviorDescription;
	}
	 ...
	 * @generated
	 */
	public BranchPath createBranchPath() {
		BranchPathImpl branchPath = new BranchPathImpl();
		return branchPath;
	}
