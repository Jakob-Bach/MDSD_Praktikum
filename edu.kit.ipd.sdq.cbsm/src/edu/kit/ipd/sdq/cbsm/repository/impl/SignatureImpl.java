 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.cbsm.repository.impl.SignatureImpl#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.cbsm.repository.impl.SignatureImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignatureImpl extends NamedElementImpl implements Signature {
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, RepositoryPackage.SIGNATURE__PARAMETERS);
		}
		return parameters;
	}
