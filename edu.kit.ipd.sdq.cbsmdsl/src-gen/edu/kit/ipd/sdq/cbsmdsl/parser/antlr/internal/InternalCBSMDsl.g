...
entryRuleCompleteArchitecture returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCompleteArchitectureRule()); }
	iv_ruleCompleteArchitecture=ruleCompleteArchitecture
	{ $current=$iv_ruleCompleteArchitecture.current; }
	EOF;

// Rule CompleteArchitecture
ruleCompleteArchitecture returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		otherlv_0='CompleteArchitecture'
		{
