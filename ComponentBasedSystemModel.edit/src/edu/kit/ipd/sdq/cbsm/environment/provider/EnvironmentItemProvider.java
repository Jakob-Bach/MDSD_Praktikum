/**
 */
package edu.kit.ipd.sdq.cbsm.environment.provider;
...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.cbsm.environment.Environment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnvironmentItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EnvironmentPackage.Literals.ENVIRONMENT__CONTAINERS);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EnvironmentPackage.Literals.ENVIRONMENT__CONTAINERS,
				 EnvironmentFactory.eINSTANCE.createContainer()));

		newChildDescriptors.add
			(createChildParameter
				(EnvironmentPackage.Literals.ENVIRONMENT__LINKS,
				 EnvironmentFactory.eINSTANCE.createLink()));
	}
