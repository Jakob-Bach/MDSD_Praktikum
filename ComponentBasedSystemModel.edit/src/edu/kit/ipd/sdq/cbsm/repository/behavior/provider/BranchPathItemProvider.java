...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.cbsm.repository.behavior.BranchPath} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BranchPathItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public BranchPathItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BranchPath"));
	}
	...
	public String getText(Object object) {
		String label = ((BranchPath)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BranchPath_type") :
			getString("_UI_BranchPath_type") + " " + label;
	}
