...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.cbsm.repository.ProvidedRole} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProvidedRoleItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProvidedRole_providedInterface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProvidedRole_providedInterface_feature", "_UI_ProvidedRole_type"),
				 RepositoryPackage.Literals.PROVIDED_ROLE__PROVIDED_INTERFACE,
				 true,
				 false,
				 true,
				 null,
