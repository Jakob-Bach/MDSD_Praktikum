...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.cbsm.repository.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_signatures_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_signatures_feature", "_UI_Service_type"),
				 RepositoryPackage.Literals.SERVICE__SIGNATURES,
				 true,
				 false,
				 true,
				 null,
