...
import edu.kit.ipd.sdq.cbsm.repository.behavior.util.BehaviorAdapterFactory;
...
public class BehaviorItemProviderAdapterFactory extends BehaviorAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link edu.kit.ipd.sdq.cbsm.repository.behavior.BehaviorDescription} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link edu.kit.ipd.sdq.cbsm.repository.behavior.BehaviorDescription}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link edu.kit.ipd.sdq.cbsm.repository.behavior.InternalAction}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link edu.kit.ipd.sdq.cbsm.repository.behavior.ExternalCall} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link edu.kit.ipd.sdq.cbsm.repository.behavior.ExternalCall}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link edu.kit.ipd.sdq.cbsm.repository.behavior.Loop} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link edu.kit.ipd.sdq.cbsm.repository.behavior.Loop}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link edu.kit.ipd.sdq.cbsm.repository.behavior.Branch} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link edu.kit.ipd.sdq.cbsm.repository.behavior.Branch}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link edu.kit.ipd.sdq.cbsm.repository.behavior.BranchPath} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected BranchPathItemProvider branchPathItemProvider;

	/**
	 * This creates an adapter for a {@link edu.kit.ipd.sdq.cbsm.repository.behavior.BranchPath}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createBranchPathAdapter() {
		if (branchPathItemProvider == null) {
			branchPathItemProvider = new BranchPathItemProvider(this);
		}

		return branchPathItemProvider;
	}
	...
	public void dispose() {
		...
		if (branchPathItemProvider != null) branchPathItemProvider.dispose();
	}
