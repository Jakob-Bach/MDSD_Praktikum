 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.cbsm.repository.CompositeComponent#getContainedAssemblyContexts <em>Contained Assembly Contexts</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.cbsm.repository.RepositoryPackage#getCompositeComponent()
 * @model
 * @generated
 */
public interface CompositeComponent extends Component {
	 ...
	 * @see edu.kit.ipd.sdq.cbsm.repository.RepositoryPackage#getCompositeComponent_ContainedAssemblyContexts()
