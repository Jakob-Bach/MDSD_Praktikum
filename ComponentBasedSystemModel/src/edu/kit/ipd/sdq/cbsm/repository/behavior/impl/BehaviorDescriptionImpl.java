 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.cbsm.repository.behavior.impl.BehaviorDescriptionImpl#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorDescriptionImpl extends MinimalEObjectImpl.Container implements BehaviorDescription {
	...
	public EList<Action> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentEList<Action>(Action.class, this, BehaviorPackage.BEHAVIOR_DESCRIPTION__ACTIONS);
		}
		return actions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviorPackage.BEHAVIOR_DESCRIPTION__ACTIONS:
