...
public class ArchitectureAdapterFactory extends AdapterFactoryImpl {
	...
	protected ArchitectureSwitch<Adapter> modelSwitch =
		new ArchitectureSwitch<Adapter>() {
			@Override
			public Adapter caseCompleteArchitecture(CompleteArchitecture object) {
				return createCompleteArchitectureAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.cbsm.architecture.CompleteArchitecture <em>Complete Architecture</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCompleteArchitectureAdapter() {
		return null;
	}
